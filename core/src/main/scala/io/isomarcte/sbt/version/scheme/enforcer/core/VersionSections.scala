...
sealed abstract class VersionSections extends Product with Serializable {
  ...
  final def canonicalString: String = {
    val preReleaseSectionString: String =
      preReleaseSection.fold(
        ""
      )(_.canonicalString)
    val metadataSectionString: String =
      metadataSection.fold(
        ""
      )(
        _.canonicalString
      )
...
object VersionSections {
  private[this] final case class VersionSectionsImpl(override val numericSection: NumericSection, override val preReleaseSection: Option[PreReleaseSection], override val metadataSection: Option[MetadataSection]) extends VersionSections
            ...
            (x.preReleaseSection, y.preReleaseSection) match {
              ...
              case (a, b) =>
                a.flatMap(
                  a => b.map(
                    b =>
                    Ordering[PreReleaseSection].compare(a, b)
                  )
                ).getOrElse(0) match {
                  case 0 =>
  ...
  /** Create a [[VersionSections]] from the [[NumericSection]], an optional
    ...
    */
  def apply(numericSection: NumericSection, preReleaseSection: Option[PreReleaseSection], metadataSection: Option[MetadataSection]): VersionSections =
    VersionSectionsImpl(numericSection, preReleaseSection, metadataSection)
  ...
  /** Create a [[VersionSections]] from the [[NumericSection]], a
    ...
    * This is the most general construction form.
    */
  def apply(numericSection: NumericSection, preReleaseSection: PreReleaseSection, metadataSection: Option[MetadataSection]): VersionSections =
    VersionSectionsImpl(numericSection, Some(preReleaseSection), metadataSection)
  ...
  /** Create a [[VersionSections]] from the [[NumericSection]], an optional
    ...
    * This is the most general construction form.
    */
  def apply(numericSection: NumericSection, preReleaseSection: Option[PreReleaseSection], metadataSection: MetadataSection): VersionSections =
    VersionSectionsImpl(numericSection, preReleaseSection, Some(metadataSection))

  /** Create a [[VersionSections]] from the [[NumericSection]],
    * [[PreReleaseSection]], and the [[MetadataSection]].
    */
  def apply(numericSection: NumericSection, preReleaseSection: PreReleaseSection, metadataSection: MetadataSection): VersionSections =
    VersionSectionsImpl(numericSection, Some(preReleaseSection), Some(metadataSection))
  ...
  /** Create a [[VersionSections]] from the [[NumericSection]]. The
    ...
    */
  def apply(numericSection: NumericSection): VersionSections =
    VersionSectionsImpl(numericSection, None, None)
